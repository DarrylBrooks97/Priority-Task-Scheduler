...
String readFileSync() {
  String contents = new File('/Users/darrylb/Documents/GitHub\ Projects/HackFSU_2019/priority_school_tasker/assets/userInfo.txt').readAsStringSync();
  return contents;
}
...
class GetHelp extends State<MyApp> {
  @override
  Widget build(BuildContext context) {
      return Scaffold(
